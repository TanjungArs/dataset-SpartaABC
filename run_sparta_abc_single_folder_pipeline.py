...
def create_sims(data_name,verbose=1,res_dir='results/',
				...
				op_sys='linux', num_simulations=100000, num_burnin=10000, minRL=80, maxRL=500):
	...
	for model in model_types:
		...
		sparta_config["_minRLVal"] = str(minRL) 
		sparta_config["_maxRLVal"] = str(maxRL) 
...
def create_sims_from_data(data_name,ow_flag=False,verbose=1,
	...
	try:
		create_sims(data_name=data_name,verbose=verbose,
					...
					cwd=cwd,op_sys=op_sys, num_simulations=num_simulations, num_burnin=num_burnin, minRL=minRL, maxRL=maxRL)
	except:
		if ow_flag:
			...
			create_sims(data_name=data_name,verbose=verbose,
						...
						msa_filename=msa_filename,
						tree_filename=tree_filename,
						minIR=minIR,maxIR=maxIR, num_alignments=num_alignments, minRL=minRL, maxRL=maxRL,
